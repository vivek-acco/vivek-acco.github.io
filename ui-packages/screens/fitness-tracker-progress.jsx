    ...
    <View style={[styles.tileContainer]}>
        <TouchableOpacity onPress={doesDataExistForProp("customerConnectedWearables") ? fetchData.bind(this, "pulse.health.fitnessActivityTracker", "Fitness Activity Tracker", "fitness-tracker-progress", "Fitness Activity Tracker --> Fetch Data") : null}>
            ...
            <View style={[{ flex: 1, display: doesDataExistForProp("customerConnectedWearables") ? "none" : "flex" }]}>
                <TouchableOpacity
                    style={[styles.buttonContainer, styles.buttonPosition, { width: 136.7, height: 33, bottom: 15.1 }]}
                    ...
                    <LinearGradient
                        ...
                        style={[styles.buttonGradient, styles.buttonSize, { width: 136.7, height: 40 }]}>
                        <Text style={[styles.boldText, styles.buttonText, { fontSize: 11, lineHeight: 12.3 }]}>{langStr("wearablesBtn")}</Text>
                    </LinearGradient>
                </TouchableOpacity>
            </View>
        </TouchableOpacity>
