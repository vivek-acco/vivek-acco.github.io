            ...
            <View>
              <View style={styles.loginBtnsContainer}>
                <SocialLogin
                  ...
                  gmailText={safeMetaLabelFinder("RegisterNew","newLoginWithGoogle","GOOGLE_CONNECT")}
                  {...this.props}
                  isGoogle
                />
                <TouchableOpacity
                ...
                >
                  ...
                  />
                  <Text style={styles.mailLoginText}>{safeMetaLabelFinder("RegisterNew","newLoginWithEmail","LOGIN_EMAIL")}</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
