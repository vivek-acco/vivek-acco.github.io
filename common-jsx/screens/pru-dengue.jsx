...
<View style={styles.tileContainer}>
    <ImageBackground
        ...
        source={{ uri: contents.prudenguemedcare }} >
        <View style={styles.titleContainer}>    
            <Text style={[{marginTop:60},styles.mainTileText]}>{langStr(labels.productCatalogPRUDengueHeader)}</Text>    
    ...
    <TouchableOpacity
        ...
        onPress={goToScreen.bind(this, "S00500", "pulse.home.pruDengue", "PRUDengue", "pru-dengue", "PRUDengue --> Get Now")}>
        <LinearGradient
