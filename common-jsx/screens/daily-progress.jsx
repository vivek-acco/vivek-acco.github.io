    ...
    <TouchableOpacity onPress={fetchData.bind(this, "pulse.home.fitnessTrackerProgress", "Fitness Tracker Progress", "tracker-progress", "Fitness Tracker Progress --> Fetch Data")}>
      <ImageBackground
        ...
        <ImageBackground
          ...
          <View style={[styles.mainContainer, { marginTop: 33.7 }]}>
            ...
            <View style={styles.stepsContainer}>
              ...
              <View style={styles.stepDetails}>
                <View style={{ marginTop: 5, justifyContent: "center", alignItens: "center" }}>
                  <View style={styles.otherDetails}>
                    <Text style={[styles.stepStyle, styles.boldText]}>{getData(0, ["commonData", "cancer-policy", "referralCount"])}</Text>
                    <Text style={[styles.stepStyle2, styles.rightAlign]}>{"/"}</Text>
                ...
                <View style={[{ justifyContent: "flex-end", marginTop: 5, justifyContent: "center", alignItens: "center" }]}>
                  <View style={styles.otherDetails}>
