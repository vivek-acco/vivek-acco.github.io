...
<View style={styles.tileContainer}>
    <ImageBackground
        ...
        <TouchableOpacity
            style={[styles.buttonPosition, styles.buttonContainer, { width: 136.7, height: 33, bottom: 15.1 }]}
            ...
            <LinearGradient
                ...
                style={[styles.buttonGradient, styles.buttonSize, { width: 136.7, height: 33 }]}>
