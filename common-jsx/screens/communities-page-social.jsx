<import model="communities-page-social" style="communities-carousel-page" content="communities-page" />
<View style={styles.tileContainer}>
    <ImageBackground
        ...
        <View style={styles.titlePosition}>
            ...
            <Text style={styles.screenText}>{langStr("communityCarousalDesc")}</Text>
        </View>
        <TouchableOpacity
